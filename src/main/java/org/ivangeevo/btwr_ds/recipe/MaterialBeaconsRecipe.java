...
public class MaterialBeaconsRecipe implements Recipe<BeaconDataRecipeInput> {
    ...
    public static class JsonBuilder implements CraftingRecipeJsonBuilder {
        ...
        public void offerTo(RecipeExporter exporter, Identifier recipeId) {
            ...
            MaterialBeaconsRecipe kilnRecipe = new MaterialBeaconsRecipe(
