...
public class BTWRDSRecipes {
    ...
    // Special recipe handlers for Material Beacons since it doesn't have its own recipe class
    ...
    public static void register() {
        ...
        Registry.register(Registries.RECIPE_TYPE, Identifier.of(MaterialBeacons.MOD_ID, "material_beacons"), MATERIAL_BEACONS_RECIPE_TYPE);
        Registry.register(Registries.RECIPE_SERIALIZER, Identifier.of(MaterialBeacons.MOD_ID, "material_beacons"), MATERIAL_BEACONS_RECIPE_SERIALIZER);
