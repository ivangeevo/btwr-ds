...
public class OGBeastEntityModel<T extends BeastEntity> extends TintableAnimalModel<T> {
	/**
	...
	public OGBeastEntityModel(ModelPart root) {
	...
	public static ModelData getModelData(Dilation dilation) {
		...
		modelPartData.addChild(
			...
			ModelPartBuilder.create()
					.uv(18, 14)
					.cuboid(-4.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, dilation),
